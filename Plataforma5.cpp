...
if (personaje->x>=x&&personaje->x<=x+250&&personaje->y+50>=y-2&&personaje->y+50<y&&personaje->saltar==false){
        personaje->y--;

}else if (personaje->x>=x&&personaje->x<=x+250&&personaje->y+50>=y-2&&personaje->y+50<y&&
